...
damage_plot <- damage_plot  + labs(title = "Historical Economic Losses by Weather Events in USA 1950 - 2011")
...
damage_injury <- damage_injury  + labs(title = "Historical Health Losses by Weather Events in USA 1950 - 2011")
